...
//         let inputStr = [...display.textContent];
//         let inputNum = [];
//         inputStr.forEach((str) => {
//           inputNum.push(Number(str));
//         });
//         let maxInput = inputNum.slice(0, 10);
//         console.log(maxInput);
//         const finalOutput = maxInput.map((num) => {
//           return String(num);
//         });
//         console.log(finalOutput);
//         if (inputNum.length === 10) {
//           console.log(finalOutput.join(''));
//           display.textContent = [finalOutput.join('')];
//         }
//       }
//     }
//   }
